...
const BusinessModel = () => {
  const tokenBenefits = [
    ...
    },
    {
      ...
      description: "Annual usage rights based on token holdings for personal stays"
    }
  ];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-xl text-gray-600 mb-6">
          Tokenized ownership structure creating sustainable value for all stakeholders
        </p>
      </div>

      <Card className="border-gray-200">
        <CardHeader>
          <CardTitle className="text-2xl text-black">Tokenization Framework</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <p className="text-gray-700 text-lg leading-relaxed">
            The BBT (Binga Beach Token) represents fractional ownership in premium beachfront property. 
            Each token provides holders with four core benefits: property ownership rights, governance 
          ...
          <div className="bg-gradient-to-br from-blue-50 to-green-50 border border-gray-200 rounded-xl p-6">
            <h4 className="text-lg font-semibold text-black mb-4">Token Economics</h4>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-2">$25</div>
                <div className="text-sm text-gray-600">Initial Token Price</div>
              </div>
              <div className="text-center">
      ...
      <Card className="border-gray-200">
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700 leading-relaxed">
            Token holders participate in democratic governance through on-chain voting mechanisms. 
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <p className="text-blue-700 text-sm">Proportional to token holdings with minimum participation thresholds</p>
            </div>
